...
ActiveRecord::Schema.define(version: 20_200_317_053_313) do
  ...
  create_table 'brands', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['subscription_id'], name: 'index_brands_on_subscription_id'
  end
  ...
  create_table 'mappingtables', force: :cascade do |t|
    t.integer 'product_id'
    t.integer 'user_id'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  ...
  create_table 'pendingpayments', force: :cascade do |t|
    t.string 'name'
    t.text 'description'
    t.integer 'price'
    t.integer 'user_id'
  ...
  create_table 'sagars', force: :cascade do |t|
    t.string 'name'
    t.string 'email'
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.string 'firstname'
    t.string 'lastname'
    t.boolean 'usertype', default: true
    t.boolean 'gender'
    t.text 'address'
    t.boolean 'status', default: true
